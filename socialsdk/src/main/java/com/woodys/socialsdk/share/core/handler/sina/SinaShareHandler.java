...
import com.woodys.socialsdk.share.core.helper.AccessTokenKeeper;
...
public class SinaShareHandler extends BaseShareHandler {
    ...
    public SinaShareHandler(Activity context, SocialShareConfiguration configuration) {
    ...
    private WeiboAuthListener mAuthListener = new WeiboAuthListener() {
        ...
        public void onWeiboException(WeiboException arg0) {
            if (getShareListener() != null) {
                getShareListener().onError(SocializeMedia.SINA, SocialShareStatusCode.ST_CODE_SHARE_ERROR_AUTH_FAILED, arg0);
            }
        }
        ...
        public void onComplete(Bundle bundle) {
            ...
            listener.onError(SocializeMedia.SINA, SocialShareStatusCode.ST_CODE_SHARE_ERROR_AUTH_FAILED, new ShareException("无效的token"));
        }
    ...
    public void onResponse(BaseResponse baseResp) {
        ...
        switch (baseResp.errCode) {
            case WBConstants.ErrorCode.ERR_OK:
                listener.onSuccess(SocializeMedia.SINA, SocialShareStatusCode.ST_CODE_SUCCESSED);
                break;
            case WBConstants.ErrorCode.ERR_CANCEL:
                listener.onCancel(SocializeMedia.SINA);
                break;
            case WBConstants.ErrorCode.ERR_FAIL:
                listener.onError(SocializeMedia.SINA, SocialShareStatusCode.ST_CODE_SHARE_ERROR_SHARE_FAILED, new ShareException(baseResp.errMsg));
                break;
        }
    }
